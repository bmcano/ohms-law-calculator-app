...
fun NavGraphBuilder.calculatorVoltage(
    navHostController: NavHostController,
) {
    composable(
        route = Screen.CalculatorVoltage.route,
        ...
        val viewModel: CalculatorViewModel = viewModel(factory = CalculatorViewModelFactory(Formulas.Volts.EQ1))
